    ...
    return [
      {
        ...
        destination: 'https://static.digiv3rse.xyz/sitemaps/:match*'
      },
      {
        source: '/u/:match*',
        has: [{ key: 'user-agent', type: 'header', value: allowedBots }],
        destination: 'https://og.digiv3rse.xyz/u/:match*'
      },
      {
        source: '/watch/:match*',
        has: [{ key: 'user-agent', type: 'header', value: allowedBots }],
        destination: 'https://og.digiv3rse.xyz/watch/:match*'
      }
    ]
  },
  async redirects() {
