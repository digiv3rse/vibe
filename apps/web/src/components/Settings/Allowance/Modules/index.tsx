...
import { DIGI_TOKEN_ADDRESS, ETHERSCAN_URL } from '@vibe/constants'
import type { ApprovedAllowanceAmountResult } from '@vibe/digi'
import {
  FollowModuleType,
...
import { shortenAddress } from '@vibe/generic'
import { Button, Select, SelectItem, Spinner } from '@vibe/ui'
      ...
      <div className="flex-1">
        <h6 className="font-medium">
          ...
          <Link
            className="text-xs"
            target="_blank"
            href={`${ETHERSCAN_URL}/address/${moduleItem.moduleContract.address}`}
          >
...
const ModuleAllowance = () => {
  ...
  const [currency, setCurrency] = useState(DIGI_TOKEN_ADDRESS)
