...
import type { ProfileOptions } from '@digiv3rse/metadata'
import {
...
import { tw, uploadToIPFS } from '@vibe/browser'
import {
...
import type { OnchainSetProfileMetadataRequest, Profile } from '@vibe/digi'
import {
...
import { AddImageOutline, Button, Input, Spinner, TextArea } from '@vibe/ui'
...
const BasicInfo = ({ profile }: Props) => {
  ...
  const { canUseDiGiManager, canBroadcast } =
    checkDiGiManagerPermissions(profile)
