...
import type { Notification, NotificationRequest } from '@vibe/digi'
import { useNotificationsQuery } from '@vibe/digi'
...
const Notifications = () => {
  ...
  const request: NotificationRequest = {
    where: {
      ...
      publishedOn: [VIBE_APP_ID, DIGITUBE_BYTES_APP_ID, DIGITUBE_APP_ID]
    }
  }
