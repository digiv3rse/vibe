...
import { AUTH_ROUTES, OWNER_ONLY_ROUTES } from '@vibe/constants'
import type { Profile } from '@vibe/digi'
import { useCurrentProfileQuery } from '@vibe/digi'
import { getIsProfileOwner, trimify } from '@vibe/generic'
...
const Layout: FC<Props> = ({
  ...
  const { loading } = useCurrentProfileQuery({
    ...
    onCompleted: ({ userSigNonces, profile }) => {
      ...
      setDiGiHubOnchainSigNonce(userSigNonces.digiHubOnchainSigNonce)
    },
    onError: () => signOut()
  })
