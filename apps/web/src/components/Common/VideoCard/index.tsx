...
import { DIGITUBE_BYTES_APP_ID } from '@vibe/constants'
import type { PrimaryPublication, VideoMetadataV3 } from '@vibe/digi'
import {
  formatNumber,
  getProfile,
  getProfilePicture,
...
import { HeartOutline } from '@vibe/ui'
...
const VideoCard: FC<Props> = ({ video }) => {
  const isBytes = video.publishedOn?.id === DIGITUBE_BYTES_APP_ID
