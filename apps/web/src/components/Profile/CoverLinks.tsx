...
import type { ProfileMetadata } from '@vibe/digi'
import { getValueFromKeyInAttributes, imageCdn } from '@vibe/generic'
import { GlobeOutline, LocationOutline } from '@vibe/ui'
