  ...
  return (
    <div className="space-y-5">
      ...
      <div className="mx-auto grid max-w-xl grid-cols-2 place-items-start gap-12">
        <Link
          href={`https://cloudflare.com/?utm_source=${VIBE_APP_NAME}`}
        ...
        <Link
          href={`https://4everland.org/?utm_source=${VIBE_APP_NAME}`}
          className="col-span-1 flex items-center justify-center md:col-span-2 lg:col-span-1"
        >
          <img
        ...
        <Link
          href={`https://livepeer.studio/?utm_source=${VIBE_APP_NAME}`}
          className="col-span-1 flex items-center justify-center md:col-span-2 lg:col-span-1"
        >
          <img
        ...
        <Link
          href={`https://betteruptime.com/?utm_source=${VIBE_APP_NAME}`}
          className="col-span-1 flex items-center justify-center md:col-span-2 lg:col-span-1"
        >
          <img
