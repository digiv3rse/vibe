...
import { VIBE_WEBSITE_URL } from '@vibe/constants'
import type { PrimaryPublication } from '@vibe/digi'
import { getPublicationData } from '@vibe/generic'
import { FireOutline, Tooltip } from '@vibe/ui'
      ...
      <div className="space-y-4">
        <div className="space-y-3">
          ...
          <div>
            <RenderLink
              link={
                getPublicationData(post.metadata)?.content ?? VIBE_WEBSITE_URL
              }
            />
          </div>
        </div>
