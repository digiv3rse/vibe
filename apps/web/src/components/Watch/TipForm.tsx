import { MetadataAttributeType, textOnly } from '@digiv3rse/metadata'
...
import { Button, Input, TextArea } from '@vibe/ui'
    ...
    try {
      ...
      const metadata = textOnly({
        ...
        marketplace: {
          ...
          external_url: `${VIBE_WEBSITE_URL}/watch/${video?.id}`
        }
      })
