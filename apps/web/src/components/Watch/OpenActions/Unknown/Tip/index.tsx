...
import { DIGI_TOKEN_ADDRESS } from '@vibe/constants'
import {
  type ModuleMetadata,
  type UnknownOpenActionModuleSettings,
  useApprovedModuleAllowanceAmountQuery
} from '@vibe/digi'
import { Button, RangeSlider, Select, SelectItem, TipOutline } from '@vibe/ui'
...
const TipOpenAction: FC<Props> = ({
  ...
  const [tip, setTip] = useState({ value: [5], currency: DIGI_TOKEN_ADDRESS })
