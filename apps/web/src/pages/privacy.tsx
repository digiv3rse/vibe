      ...
      <div className="relative px-2">
        <div className="prose-sm md:prose prose-slate dark:prose-invert prose-a:font-bold prose-a:text-brand-500 hover:prose-a:text-brand-600 mx-auto max-w-4xl">
          ...
          <p>
            ...
            description of how {VIBE_APP_NAME} (“we,” “our,” or “us”) collects,
            uses, and shares information about you in connection with the
            website at digiv3rse.xyz”, as well as your rights and choices
          ...
          <p>
            ...
            blockchain. Interactions with the DiGi Protocol rely on smart
          ...
          <p>
            ...
            contact us at{' '}
            <Link href="mailto:privacy@digiv3rse.xyz">
              privacy@digiv3rse.xyz
            </Link>
            .
          </p>
        </div>
