export const DIGI_PERMISSIONLESS_CREATOR_ABI = [
  {
    inputs: [
      { internalType: 'address', name: 'owner', type: 'address' },
      { internalType: 'address', name: 'digiHub', type: 'address' },
      { internalType: 'address', name: 'digiHandles', type: 'address' },
  ...
  },
  {
    ...
    name: 'DIGI_HANDLES',
    outputs: [
      { internalType: 'contract IDiGiHandles', name: '', type: 'address' }
    ],
