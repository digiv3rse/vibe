export const VIBE_SIGNUP_PROXY_ABI = [
  ...
  {
    inputs: [],
    name: 'digiPermissionlessCreator',
    outputs: [
      {
        internalType: 'contract IDiGiPermissionlessCreator',
        name: '',
        type: 'address'
      }
    ],
  ...
  },
  {
    inputs: [
      ...
      {
        internalType: 'address',
        name: 'digiPermissionlessCreatorAddress',
        type: 'address'
      }
    ],
    name: 'initialize',
  ...
  },
  {
    ...
    name: 'setDiGiPermissionlessCreatorAddress',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function'
  },
